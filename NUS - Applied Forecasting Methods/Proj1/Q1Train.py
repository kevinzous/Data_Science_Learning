...
# ['AGE775214', 'SEX255214', 'RHI225214', 'EDU635213', 'PVY020213']

##Formula of the linear regression
#transfomation
Features[2]='np.sqrt('+Features[2]+')'  ##np.sqrt(RHI225214)
seperator = '+'
...
ListFeatures=[Features,Candidates,Features_fw,Features_bw,Features_fw_int]
ListFormula = ['HilaryPercent ~ '+seperator.join(i) for i in ListFeatures]
Name = ['1st step','full','Features_fw','Features_bw','Features_fw_int']
...
for i in range(0,len(ListFeatures)):
    ...
    print('rsquare: {}'.format(modal.rsquared))
