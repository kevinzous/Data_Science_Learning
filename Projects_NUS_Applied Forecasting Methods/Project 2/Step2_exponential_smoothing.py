...
result_mul = seasonal_decompose(df['TrafficVolume'], model='multiplicative', extrapolate_trend='freq')

# Additive Decomposition
result_add = seasonal_decompose(df['TrafficVolume'], model='additive', extrapolate_trend='freq')
